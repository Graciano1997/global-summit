...
// sectionSpeakers.append(h2,hr,divSpeakers,createButton());

// document.querySelector('.partnerSection').insertAdjacentElement("beforebegin",sectionSpeakers);
...
for(let speak in speakersArray){ 
    if(controla>3){
        divSpeakers.append(buildSpeaker(speakersArray[speak],"last"));
        //break;
    }else{
        divSpeakers.append(buildSpeaker(speakersArray[speak]));
    }
